...
export const fetchCourseDetails = async (courseId) => {
  ...
  // console.log("CourseId in fetchCourseDe", courseId);
  let result = null;
  try {
...
//! add the course details(Work properly)
export const addCourseDetails = async (data, token) => {
  let result = null;
  // console.log("token in AddCourse", token);
  // const headers = {
  //   Authorization: `Bearer ${token}`,
  // };
  // console.log("Headers", headers);
  //   console.log("data in addcoursedetails in client", data);
...
export const createSection = async (data, token) => {
  ...
  try {
    ...
    // console.log("response in create section", response);
...
export const updateSection = async (data, token) => {
  let result = null;
 // console.log("data in updateSection", data);
  const toastId = toast.loading("Loading...");
  try {
...
export const getFullDetailsOfCourse = async (courseId, token) => {
 // console.log("course id in getfullcourse", courseId);
  const toastId = toast.loading("Loading...");
  //   dispatch(setLoading(true));
  let result = null;
  try {
...
export const markLectureAsComplete = async (data, token) => {
 ...
 // console.log("token in markedlecture oprations", token);
  const toastId = toast.loading("Loading...");
  try {
   ...
   // console.log("MARK_LECTURE_AS_COMPLETE_API API RESPONSE............", response);
    ...
    if (!response.data.message) {
      throw new Error(response.dataconsole.error);
    }
...
export const showAllCategories = async (token) => {
  ...
  try {
   ...
   // console.log("All categoey response", response);
    if (!response?.data?.success) {
   ...
   // console.log("Show All category API ERROR............", error);
    toast.error(error.message);
  }
  toast.dismiss(toastId);
  return result;
